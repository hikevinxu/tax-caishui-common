    ...
    <div class="container">
      ...
      <div class="register" v-if="formData.pageType == 1">
        ...
        <div class="inputItem submitBtn">
          <van-button type="primary" size="large" @click="register">{{formData.buttonRemark}}</van-button>
        </div>
      </div>
      <div class="download" v-if="formData.pageType == 2">
        <div class="inputItem downloadBtn">
          <van-button type="primary" size="large" @click="download">{{formData.buttonRemark}}</van-button>
        </div>
  ...
  .container {
    ...
    .register {
      ...
      .getYZM {
        ...
        .van-button--primary {
          border: 1px solid rgba(250,162,19,1);
          border-radius: 3px;
        }
        .van-button__text {
          letter-spacing: 4px;
